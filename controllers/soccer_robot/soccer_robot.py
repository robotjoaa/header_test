...
class SoccerRobot(Robot):
    def __init__(self, noise):
        ...
        self.left_arm = self.getDevice('left arm motor')
        self.right_arm = self.getDevice('right arm motor')
        self.left_leg = self.getDevice('left leg motor')
        self.right_leg = self.getDevice('right leg motor')
        self.left_leg2 = self.getDevice('left leg motor2')
        self.right_leg2 = self.getDevice('right leg motor2')
